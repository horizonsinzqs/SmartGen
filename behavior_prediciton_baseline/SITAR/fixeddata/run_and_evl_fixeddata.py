...
from DataSet_fixed import FixedLengthActionOnlyDataset, collate_fn_fixed
from SITAR_fixed import SITAR_Fixed
...
def create_model(dataset, d_model=40):
...
def main():
    parser = argparse.ArgumentParser(description='SITAR Fixed Length Action-Only Training')
