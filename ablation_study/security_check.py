...
def security_check(dataset, new_env, thres, method, model):
    ...
    epochs = 10
    seq_len = 40
    data_file = f'study_data/ablation2/{dataset}_{new_env}_generation_{method}_th={thres}_{model}_seq.pkl'
    save_file = f'study_data/ablation2/{dataset}_{new_env}_generation_{method}_th={thres}_{model}_seq_filter.pkl'
    ...
    outlier_file = f'study_data/ablation2/{dataset}_{new_env}_generation_{method}_th={thres}_{model}_seq_filter_out'
    flag = save_outliers(outlier_sequence, outlier_file)

    if flag == 1:
        print('============================NEED FIND TRUE OUTLIER================================ \n')
        trn_file = f'study_data/ablation2/{dataset}_{new_env}_generation_{method}_th={thres}_{model}_seq_filter_trn.pkl'
        vld_file = f'study_data/ablation2/{dataset}_{new_env}_generation_{method}_th={thres}_{model}_seq_filter_vld.pkl'
        ...
        for i in range(len(outlier_sequence)):
            add_file = f'study_data/ablation2/{dataset}_{new_env}_generation_{method}_th={thres}_{model}_seq_filter_out_{i}.pkl'
    ...
    true_save_file = f'study_data/ablation2/{dataset}_{new_env}_generation_{method}_th={thres}_{model}_seq_filter_true.pkl'
    with open(data_file, 'rb') as file:
        sequences = pickle.load(file)
